...
Конвертер изображений в ASCII-арт на Rust. Превращает обычные фотографии в стильные текстовые рисунки, которые можно вывести в терминал или сохранить в файл.
...
### Опции (примерные, зависит от реализации)
